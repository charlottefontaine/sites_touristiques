CITIES ={
    ...
    "Valencia": "https://www.visitvalencia.com/en",
...
project_stopwords = [
    ...
    "monaco", "ostende","oostende","ostend","de","city", "city","one","barcelonaturismecom","vimeocomvisitvalencia","https","popup","submit","button",
